...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "I would like to thank all the lads brasenose body shop for an amazing job on my car. 🚘 Can’t thank you enough. Great customer services made you feel really welcome. I would highly recommend. Thanks again boys 👍💯",
    name: "debbie smith",
  },
